...
class CoursePage extends Component {
  ...
  componentDidMount() {
    ...
    AuthServices.IsPurchased(this.state.CourseId, localStorage.userId).then(
      (response) => {
        // Access the isPurchased value from the response data
        const isPurchased = response.data.isPurchased;
    ...
    //   console.log("coursepurchased:", isCoursePurchased);
    //   localStorage.setItem("purchased", "true");
    // } else {
    //   // If not purchased, you may want to remove the 'purchased' flag from local storage
    //   localStorage.removeItem("purchased");
    // }
  }
